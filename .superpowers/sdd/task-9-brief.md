...
**Interfaces:**
- Produces: `add_progress_bar(input_path, output_path=None, position="bottom", height=5, bg_color="808080", fg_color="FF0000", bg_alpha=1.0, fg_alpha=1.0, segment_interval=1, corner_radius=0, chapters=None, divider_width=3, divider_height_ratio=0.8, gradient=None, scrubber_image=None) -> bool`
...
```bash
python -c "from vpbar.progress import add_progress_bar; print('ok')"
```
