...
**Interfaces:**
- Produces: `convert_video_to_gif(input_path: str, output_path: str, height: int = 60, green_screen: bool = False, green_threshold: int = 150) -> bool`
...
```bash
python -c "from vpbar.gif import convert_video_to_gif; print('ok')"
```
