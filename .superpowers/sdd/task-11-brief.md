### Task 11: Create `cli.py` with subcommand dispatch

**Files:**
- Modify: `vpbar/cli.py` (currently a stub from Task 1)

**Interfaces:**
- Consumes: All other vpbar modules
- Produces: `main()` that dispatches `progress add` and `gif convert` subcommands

- [ ] **Step 1: Replace `vpbar/cli.py` with full implementation**
...
- [ ] **Step 2: Verify both help messages work**

```bash
python -m vpbar --help
# Shows: usage: vpbar [-h] {progress,gif} ...

python -m vpbar progress add --help
# Shows all progress add options

python -m vpbar gif convert --help
# Shows all gif convert options
```
